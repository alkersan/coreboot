...
Device (GPI0)
{
	...
	/* first bank/group in community 0: GPP_D */
...
/* GPIO Community 3: CPUJTAG1 (reserved), CPUJTAG (reserved), GPP_H, GPP_A, VGPIO3 */
Device (GPI3)
{
	Name (_HID, ACPI_GPIO_HID)
	Name (_CID, ACPI_GPIO_CID)
	...
	Name (_DSD, Package (0x04)
	{
		...
		Package (0x05)
		{
			...
			Package (0x02)
			{
 			...
 			Package (0x02)
 			{
 				"intc-gpio-group-4-subproperties",
 				VGP3
 			}
		}
	})
	/* first bank/group in community 3: RSV1 */
	Name (RSV1, Package (0x02)
	{
		ToUUID ("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
		Package (0x03)
		{
			...
			{
				"intc-gpio-group-offset",
				GPP_RSVD1_START_OFFSET
			}
		}
	})

	/* 2nd bank/group in community 3: RSV2 */
	Name (RSV2, Package (0x02)
	{
		ToUUID ("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
		Package (0x03)
		{
			...
			{
				"intc-gpio-group-offset",
				GPP_RSVD2_START_OFFSET
			}
		}
	})

	/* 3rd bank/group in community 3: GPP_H */
	...
	/* 4th bank/group in community 3: GPP_A */
	...
	/* 5th bank/group in community 3: VGPIO3 */
...
/* GPIO Community 5: GPP_B, GPP_V, VGPIO */
Device (GPI5)
{
	Name (_HID, ACPI_GPIO_HID)
	Name (_CID, ACPI_GPIO_CID)
	...
	/* 2nd bank/group in community 5: GPP_V */
