...
const char *soc_acpi_name(const struct device *dev)
{
	...
	case PCI_DEVFN_I3C1:		return "I3C1";
	case PCI_DEVFN_I3C2:		return "I3C2";
	...
	case PCI_DEVFN_PCIE13:	return "RP13";
	case PCI_DEVFN_PCIE14:	return "RP14";
...
struct chip_operations soc_intel_novalake_ops = {
	.name = "Intel Nova Lake",
