...
/* SaGv gears */
enum soc_intel_novalake_sagv_gears {
	GEAR_AUTO = 0,
	GEAR_1 = 1,
	GEAR_2 = 2,
	GEAR_4 = 4,
...
struct soc_intel_novalake_config {
	...
	/* true: this USB2 port is for integrated camera  */
	uint8_t usb2_camera_ports[CONFIG_SOC_INTEL_USB2_DEV_MAX];
	...
	/* iDisp-Link Interface 0: Disabled, 1: HD-Audio, 2: SoundWire. */
	enum {
		IDISP_LINK_DISABLED,
		IDISP_LINK_HDA,
		IDISP_LINK_SNDW,
	} pch_hda_idisp_link_interface;
	...
	*/
	...
	uint8_t serial_io_i3c_mode[CONFIG_SOC_INTEL_I3C_DEV_MAX];
	 ...
	 * This is a bitfield that corresponds to up to 4 TCSS ports on NVL.
...
typedef struct soc_intel_novalake_config config_t;

#endif /* _SOC_NOVALAKE_CHIP_H_ */
