...
#ifndef _SOC_NOVALAKE_GPIO_SOC_DEFS_H_
#define _SOC_NOVALAKE_GPIO_SOC_DEFS_H_
...
/*
 * NOTE: The following GPP group value comes from GPIO_MISC registers and they
 * also need to map to PMC GPIO_CFG register.
 */
/* GPIO COMM 0 */
#define GPP_D		0x8
#define GPP_C		0x1
...
#define GPP_I3C_CLK_LPBK	INC(GPP_D25)

#define NUM_GRP_D_PADS		(GPP_I3C_CLK_LPBK - GPP_D00 + 1)
 ...
 * +------------------+---------+
 */
#define GPP_C00			INC(GPP_I3C_CLK_LPBK)
#define GPP_C01			INC(GPP_C00)
#define GPP_C02			INC(GPP_C01)
#define GPP_C03			INC(GPP_C02)		/* 30 */
...
#define GPP_C23			INC(GPP_C22)		/* 50 */

#define NUM_GRP_C_PADS		(GPP_C23 - GPP_C00 + 1)
#define NUM_GPP_C_PADS		(GPP_C23 - GPP_C00 + 1)

#define COM0_GRP_PAD_START	GPP_D00
#define COM0_GRP_PAD_END	GPP_C23
#define NUM_COM0_GRP_PADS	(GPP_C23 - GPP_D00 + 1)
#define NUM_COM0_GPP_PADS	(NUM_GPP_D_PADS + NUM_GPP_C_PADS)
...
#define GPP_F19			INC(GPP_F18)		/* 70 */
#define GPP_F20			INC(GPP_F19)
#define GPP_F21			INC(GPP_F20)
#define GPP_F22			INC(GPP_F21)
#define GPP_F23			INC(GPP_F22)
#define GPP_THC1_GSPI1_I3C1_CLK_LPBK	INC(GPP_F23)
#define GPP_GSPI0_CLK_LOOPBK		INC(GPP_THC1_GSPI1_I3C1_CLK_LPBK)
 ...
 * +------------------+---------+
 *
 * NOTE: GPP_E00 is not a connected PAD in NVL and should be treated
 * as other internal used only PADs. It is not meant to be used.
 * ref doc: Nova Lake H GPIO Implementation Summary (#817954)
 */
#define GPP_E00			INC(GPP_GSPI0_CLK_LOOPBK)
#define GPP_E01			INC(GPP_E00)
#define GPP_E02			INC(GPP_E01)
#define GPP_E03			INC(GPP_E02)		/* 80 */
...
#define GPP_BOOTHALT_B		INC(GPP_E22)		/* 100 */
#define GPP_THC0_GSPI0_I3C0_I3C3_CLK_LPBK	INC(GPP_BOOTHALT_B)

#define NUM_GRP_E_PADS		(GPP_THC0_GSPI0_I3C0_I3C3_CLK_LPBK - GPP_E00 + 1)
#define NUM_GPP_E_PADS		(GPP_E22 - GPP_E00 + 1)

#define COM1_GRP_PAD_START	GPP_F00
#define COM1_GRP_PAD_END	GPP_THC0_GSPI0_I3C0_I3C3_CLK_LPBK
#define NUM_COM1_GRP_PADS	(GPP_THC0_GSPI0_I3C0_I3C3_CLK_LPBK - GPP_F00 + 1)
 ...
 * |                  | NVL-H   |
 * +------------------+---------+
 * | Pad Start Number |    102  |
 * +------------------+---------+
 * | Pad End Number   |    103  |
 * +------------------+---------+
 */
#define GPP_EPD_ON		INC(GPP_THC0_GSPI0_I3C0_I3C3_CLK_LPBK)
#define GPP_VDD2_PWRGD		INC(GPP_EPD_ON)

#define NUM_GRP_RSVD1_PADS	(GPP_VDD2_PWRGD - GPP_EPD_ON + 1)
#define NUM_GPP_RSVD1_PADS	0
...
#define GPP_JTAG_TDO		INC(GPP_JTAG_MBPB1)
#define GPP_JTAGX		INC(GPP_JTAG_TDO)
#define GPP_PRDY_B		INC(GPP_JTAGX)
#define GPP_PREQ_B		INC(GPP_PRDY_B)
#define GPP_JTAG_TDI		INC(GPP_PREQ_B)		/* 110 */
...
#define NUM_GRP_RSVD2_PADS	(GPP_DDSP_HPDALV - GPP_JTAG_MBPB0 + 1)
#define NUM_GPP_RSVD2_PADS	0
...
#define GPP_H04			INC(GPP_H03)		/* 120 */
...
#define GPP_H14			INC(GPP_H13)		/* 130 */
...
#define GPP_H24			INC(GPP_H23)		/* 140 */
...
#define GPP_LPI3C2_CLK_LPBK	INC(GPP_ISHI3C1_CLK_LPBK)
#define GPP_LPI3C3_CLK_LPBK	INC(GPP_LPI3C2_CLK_LPBK)

#define NUM_GRP_H_PADS		(GPP_LPI3C3_CLK_LPBK - GPP_H00 + 1)
 ...
 * |                  | NVL-H   |
 * +------------------+---------+
 * | Pad Start Number |    146  |
 * +------------------+---------+
 * | Pad End Number   |    173  |
 * +------------------+---------+
 */
#define GPP_A00			INC(GPP_LPI3C3_CLK_LPBK)
#define GPP_A01			INC(GPP_A00)
#define GPP_A02			INC(GPP_A01)
#define GPP_A03			INC(GPP_A02)
#define GPP_A04			INC(GPP_A03)		/* 150 */
...
#define GPP_A14			INC(GPP_A13)		/* 160 */
...
#define GPP_SPI0_FLASH_1_CS_B	INC(GPP_SPI0_FLASH_0_CS_B)	/* 170 */
 ...
 * |                  | NVL-H   |
 * +------------------+---------+
 * | Pad Start Number |    174  |
 * +------------------+---------+
 * | Pad End Number   |    205  |
 * +------------------+---------+
 */
#define GPP_VGPIO3_USB_OCB_RX_0		INC(GPP_SPI0_CLK_LOOPBK)
#define GPP_VGPIO3_USB_OCB_RX_1		INC(GPP_VGPIO3_USB_OCB_RX_0)
#define GPP_VGPIO3_USB_OCB_RX_2		INC(GPP_VGPIO3_USB_OCB_RX_1)
#define GPP_VGPIO3_USB_OCB_RX_3		INC(GPP_VGPIO3_USB_OCB_RX_2)
#define GPP_VGPIO3_USB_OCB_TX_0		INC(GPP_VGPIO3_USB_OCB_RX_3)
#define GPP_VGPIO3_USB_OCB_TX_1		INC(GPP_VGPIO3_USB_OCB_TX_0)
#define GPP_VGPIO3_USB_OCB_TX_2		INC(GPP_VGPIO3_USB_OCB_TX_1)	/* 180 */
#define GPP_VGPIO3_USB_OCB_TX_3		INC(GPP_VGPIO3_USB_OCB_TX_2)
#define GPP_VGPIO3_TS0			INC(GPP_VGPIO3_USB_OCB_TX_3)
...
#define GPP_VGPIO3_ESPI_0		INC(GPP_VGPIO3_THC3)
#define GPP_VGPIO3_ESPI_1		INC(GPP_VGPIO3_ESPI_0)
#define GPP_VGPIO3_ESPI_2		INC(GPP_VGPIO3_ESPI_1)		/* 190 */
#define GPP_VGPIO3_ESPI_3		INC(GPP_VGPIO3_ESPI_2)
#define GPP_VGPIO3_ESPI_4		INC(GPP_VGPIO3_ESPI_3)
#define GPP_VGPIO3_ESPI_5		INC(GPP_VGPIO3_ESPI_4)
#define GPP_VGPIO3_ESPI_6		INC(GPP_VGPIO3_ESPI_5)
#define GPP_VGPIO3_ESPI_7		INC(GPP_VGPIO3_ESPI_6)
#define GPP_VGPIO3_ESPI_8		INC(GPP_VGPIO3_ESPI_7)
#define GPP_VGPIO3_ESPI_9		INC(GPP_VGPIO3_ESPI_8)
#define GPP_VGPIO3_ESPI_10		INC(GPP_VGPIO3_ESPI_9)
#define GPP_VGPIO3_ESPI_11		INC(GPP_VGPIO3_ESPI_10)
#define GPP_VGPIO3_ESPI_12		INC(GPP_VGPIO3_ESPI_11)		/* 200 */
#define GPP_VGPIO3_ESPI_13		INC(GPP_VGPIO3_ESPI_12)
#define GPP_VGPIO3_ESPI_14		INC(GPP_VGPIO3_ESPI_13)
#define GPP_VGPIO3_ESPI_15		INC(GPP_VGPIO3_ESPI_14)
#define GPP_VGPIO3_EC_SCI		INC(GPP_VGPIO3_ESPI_15)
#define GPP_VGPIO3_EC_SCI1		INC(GPP_VGPIO3_EC_SCI)

#define NUM_GRP_VGPIO3_PADS	(GPP_VGPIO3_EC_SCI1 - GPP_VGPIO3_USB_OCB_RX_0 + 1)
#define NUM_GPP_VGPIO3_PADS	0

#define COM3_GRP_PAD_START	GPP_EPD_ON
#define COM3_GRP_PAD_END	GPP_VGPIO3_EC_SCI1
#define NUM_COM3_GRP_PADS	(GPP_VGPIO3_EC_SCI1 - GPP_EPD_ON + 1)
#define NUM_COM3_GPP_PADS	(NUM_GPP_H_PADS + NUM_GPP_A_PADS)
#define NUM_COM3_GROUPS		5
 ...
 * |                  | NVL-H   |
 * +------------------+---------+
 * | Pad Start Number |    206  |
 * +------------------+---------+
 * | Pad End Number   |    213  |
 * +------------------+---------+
 */
#define GPP_S00			INC(GPP_VGPIO3_EC_SCI1)
#define GPP_S01			INC(GPP_S00)
#define GPP_S02			INC(GPP_S01)
#define GPP_S03			INC(GPP_S02)
#define GPP_S04			INC(GPP_S03)		/* 210 */
...
#define GPP_B06			INC(GPP_B05)		/* 220 */
...
#define GPP_B16			INC(GPP_B15)		/* 230 */
...
#define GPP_ISHI3C0_CLK_LPBK	INC(GPP_B25)		/* 240 */
#define GPP_A_GSPI1_CLK_LPBK	INC(GPP_ISHI3C0_CLK_LPBK)
#define GPP_GSPI2_CLK_LPBK	INC(GPP_A_GSPI1_CLK_LPBK)

#define NUM_GRP_B_PADS		(GPP_GSPI2_CLK_LPBK - GPP_B00 + 1)
 ...
 * |                  | NVL-H   |
 * +------------------+---------+
 * | Pad Start Number |    243  |
 * +------------------+---------+
 * | Pad End Number   |    266  |
 * +------------------+---------+
 */
#define GPP_V00			INC(GPP_GSPI2_CLK_LPBK)
...
#define GPP_V07			INC(GPP_V06)		/* 250 */
...
#define GPP_V17			INC(GPP_V16)		/* 260 */
#define GPP_RESET_SYNC_B	INC(GPP_V17)
#define GPP_SYS_RESET_B		INC(GPP_RESET_SYNC_B)
#define GPP_BKLTEN		INC(GPP_SYS_RESET_B)
#define GPP_BKLTCTL		INC(GPP_BKLTEN)
#define GPP_VDDEN		INC(GPP_BKLTCTL)
#define GPP_MLK_RST_B		INC(GPP_VDDEN)

#define NUM_GRP_V_PADS		(GPP_MLK_RST_B - GPP_V00 + 1)
 ...
 * |                  | NVL-H   |
 * +------------------+---------+
 * | Pad Start Number |    267  |
 * +------------------+---------+
 * | Pad End Number   |    284  |
 * +------------------+---------+
 */
#define GPP_VGPIO0		INC(GPP_MLK_RST_B)
#define GPP_VGPIO5		INC(GPP_VGPIO0)
#define GPP_VGPIO30		INC(GPP_VGPIO5)
#define GPP_VGPIO31		INC(GPP_VGPIO30)	/* 270 */
...
#define GPP_VGPIO43		INC(GPP_VGPIO42)	/* 280 */
