...
/* TODO: b/510835894 - Consolidate cse_telemetry.c with PTL/ADL/MTL common timestamps.
 * Move shared CSE timestamps to a common cse_telemetry.c with a weak override for
 * SoC-specific telemetry data. */
