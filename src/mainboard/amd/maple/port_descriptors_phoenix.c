...
#define phx_wlan_dxio_descriptor {				\
	...
	.start_lane = CONFIG(ENABLE_WLAN02_MAPLE) ? 14 : 15,	\
	.end_lane = 15,		                  \
	.device_number = 2,				\
	.function_number = 2,				\
	.link_speed_capability = GEN_MAX,		\
...
#define phx_ssd1_dxio_descriptor {			\
	.engine_type = PCIE_ENGINE,			\
	.port_present = CONFIG(ENABLE_SSD1_MAPLE),		\
	.start_lane = 8,				\
	.end_lane = 11,					\
	.device_number = 1,				\
	.function_number = 2,				\
...
#define phx_wwan_dxio_descriptor {				\
	...
	.start_lane = 12,				\
	.end_lane = CONFIG(ENABLE_WWAN02_MAPLE) ? 13 : 12,		\
	.device_number = 2,				\
	.function_number = 3,				\
	.link_speed_capability = GEN_MAX,		\
	.turn_off_unused_lanes = true,			\
...
static fsp_ddi_descriptor maple_ddi_descriptors[] = {
	{ /* DDI0 - eDP */
...
{
	maple_ddi_descriptors[1].connector_type = get_ddi1_type();

	printk(BIOS_DEBUG, "Using Maple PHX DXIO\n");
	static const fsp_dxio_descriptor maple_phx_dxio_descriptors[] = {
	...
	*dxio_descs = maple_phx_dxio_descriptors;
	*dxio_num = ARRAY_SIZE(maple_phx_dxio_descriptors);
	*ddi_descs = maple_ddi_descriptors;
	*ddi_num = ARRAY_SIZE(maple_ddi_descriptors);
}
